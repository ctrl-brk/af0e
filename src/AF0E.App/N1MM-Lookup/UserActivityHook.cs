...
public class UserActivityHook
{
    ...
    /// </remarks>
    [StructLayout(LayoutKind.Sequential)]
    private sealed class MouseHookStruct
    {
        /// <summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    private sealed class MouseLLHookStruct
    {
        /// <summary>
        /// Specifies a POINT structure that contains the x- and y-coordinates of the cursor, in screen coordinates. 
        /// </summary>
    ...
    public void Start(bool InstallMouseHook = true, bool InstallKeyboardHook = true)
    {
        ...
        if (hKeyboardHook != 0 || !InstallKeyboardHook) return;
    ...
    private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
    {
        ...
        //double clicks
        var clickCount = 0;
        if (button != MouseButtons.None) clickCount = wParam is WM_LBUTTONDBLCLK or WM_RBUTTONDBLCLK ? 2 : 1;
    ...
    private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
    {
        ...
        //raise KeyDown
        if (KeyDown != null && wParam is WM_KEYDOWN or WM_SYSKEYDOWN)
        {
