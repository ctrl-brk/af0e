...
--select @parkId = 12012, @parkNum = 'US-12456', @grid = 'DN80ub', @city = null,         @county = 'Yuma',       @state = 'CO', @lat = 40.083693, @long = -102.275232 -- US-12456 (Stalker Lake SWA)
--select @parkId = 2881,  @parkNum = 'US-11899', @grid = 'DM89vo', @city = null,         @county = 'Yuma',       @state = 'CO', @lat = 39.636404, @long = -102.185828 -- US-11899 (South Republican SWA)
